    ...
    for result in results:
        ...
        lines.extend(
            [
                ...
                "[ ] Unclear",
                "",
                "Reliability issue (severity; Phase 5J-B):",
                "[ ] none",
                "[ ] non_blocking_overclaim",
                "[ ] blocking_reliability",
                "[ ] Unclear",
                "",
                "Reliability category (optional):",
                "[ ] factual_error",
    ...
    guide_md.write_text(
        "\n".join(
            [
                ...
                "",
                "## Hallucination vs reliability severity (Phase 5J-B)",
                "",
                "- `hallucination_risk`: which response(s) show risk? (A/B/Both/Neither)",
                "- `reliability_issue`: is it readiness-blocking?",
                "  (`none` / `non_blocking_overclaim` / `blocking_reliability` / `unclear`)",
                "- Non-blocking: strong theology/exegesis, aspect overreading, homiletics",
                "- Blocking: factual error, anachronism, invented concretes, ID leaks,",
                "  unsupported concrete historical claims as fact",
                "",
                "## After reading",
                "",
                "1. Fill the Human review section in the campaign HUMAN_REVIEW.md",
                "2. Persist with `python -m textus_kb review-rate <run_id> ...`",
                "   including `--reliability` when risk is present",
